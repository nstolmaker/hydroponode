...
//    console.log(process.env)
    ...
    this.SENDPULSE_EMAIL = process.env.SENDPULSE_EMAIL || "nstolmaker@gmail.com"
    this.SENDPULSE_PASSWORD = process.env.SENDPULSE_PASSWORD || "NO_PASSWORD_READ_FROM_ENV.YOUSHOULDSET.SENDPULSE_PASSWORD"
